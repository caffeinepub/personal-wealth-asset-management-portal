...
& Asset Management Portal on your Windows computer without an internet 
connection.
...
2. Read WINDOWS_RUN_INSTRUCTIONS.txt for detailed setup instructions

3. Run one of the launcher scripts:
   • start-server-win.bat (double-click to run)
   • start-server-win.ps1 (right-click → Run with PowerShell)
...
• Node.js 14+ (recommended) OR Python 3+ (alternative)

If you don't have Node.js or Python installed, download from:
...
✓ Net Worth - Calculate total net worth
✓ Cashflow - Track money to collect and give
✓ Daily P/L - Daily profit/loss reports
